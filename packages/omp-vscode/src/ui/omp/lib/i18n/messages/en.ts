...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "workbench.footer.settings":
      "Changes save immediately to ~/.omp/agent/config.yml",
    ...
    "workbench.footer.agents":
      "Edit agent definitions in ~/.omp/agent/agents/*.yml",
    "workbench.footer.usage": "Provider usage from _omp/usage",
    "workbench.footer.auth":
      "Manage credentials · OAuth requires an external browser",
    ...
    "settings.appearance.tuiNote":
      "These settings target the TUI (`omp` in a terminal): theme colors, status-line format, Nerd-Font glyphs, inline-image protocol. The VS Code webview uses VS Code's own theme, so most of them have no visible effect here — they are still persisted to ~/.omp/agent/config.yml and shared with the CLI.",
    ...
    "mcp.empty":
      'No MCP servers configured. Click "Add MCP server" below to install one.',
    ...
    "usage.savedResets":
      "{count} saved rate-limit reset available — /usage reset to spend",
    "usage.savedResets.plural":
      "{count} saved rate-limit resets available — /usage reset to spend",
    ...
    "auth.oauthNotAvailable":
      "OAuth not available from the VS Code extension — run `omp auth login {provider}` in a terminal instead.",
    "auth.chip.oauth": "OAuth",
    "auth.chip.apiKey": "API Key",
    "auth.chip.local": "Local",
    "auth.footer":
      "You can also manage credentials via `omp auth` in a terminal.",
    ...
    "settings.autoResume.description":
    ...
    "settings.power.sleepPrevention.option.off.description":
      "Do not prevent any sleep",
    ...
    "settings.advisor.subagents.description":
      "Also enable the advisor on spawned task/eval subagents.",
    ...
    "settings.advisor.immuneTurns.option.0.description":
      "Allow every concern/blocker to interrupt.",
    ...
    "settings.modelRoleStorage.description":
    ...
    "settings.modelRoles.description":
      "Assign models and thinking levels to model roles",
    ...
    "settings.symbolPreset.option.unicode.description":
      "Standard symbols (default)",
    ...
    "settings.statusLine.preset.option.default.description":
      "Model, path, git, context, tokens, cost",
    "settings.statusLine.preset.option.minimal.label": "Minimal",
    "settings.statusLine.preset.option.minimal.description":
      "Path and git only",
    ...
    "settings.statusLine.separator.option.ascii.description":
      "Greater-than signs",
    ...
    "settings.terminal.showImages.description":
    ...
    "settings.defaultThinkingLevel.option.auto.description":
      "Automatically select thinking effort for each turn",
    ...
    "settings.hideThinkingBlock.description":
    ...
    "settings.personality.option.none.description":
      "Omit the personality block entirely",
    ...
    "settings.textVerbosity.option.medium.description":
      "Balance brevity and detail (default)",
    "settings.textVerbosity.option.high.label": "High",
    "settings.textVerbosity.option.high.description":
      "Prefer detailed responses",
    "settings.steeringMode.label": "Steering Mode",
    "settings.steeringMode.description":
    ...
    "settings.followUpMode.description":
    ...
    "settings.interruptMode.description":
    ...
    "settings.treeFilterMode.description":
    ...
    "settings.startup.quiet.description":
    ...
    "settings.startup.checkUpdate.description":
    ...
    "settings.marketplace.autoUpdate.option.auto.description":
      "Check on startup and auto-install updates",
    ...
    "settings.completion.notify.description":
    ...
    "settings.error.notify.description":
    ...
    "settings.ask.notify.description":
    ...
    "settings.share.store.description":
    ...
    "settings.stt.enabled.description":
    ...
    "settings.compaction.enabled.description":
    ...
    "settings.compaction.autoContinue.description":
    ...
    "settings.snapcompact.systemPrompt.option.none.description":
      "Keep the system prompt as text.",
    ...
    "settings.snapcompact.shape.option.8x8r-sent.label":
    ...
    "settings.snapcompact.shape.option.6x6u-sent.label":
    ...
    "settings.snapcompact.shape.option.5x8-sent.label":
    ...
    "settings.snapcompact.shape.option.6x12-dim.label":
    ...
    "settings.branchSummary.enabled.description":
    ...
    "settings.memory.backend.option.off.description":
      "No memory subsystem runs",
    ...
    "settings.mnemopi.autoRecall.description":
    ...
    "settings.hindsight.autoRecall.description":
    ...
    "settings.hindsight.retainMode.option.last-turn.description":
      "Chunked retention sliced by turn boundaries",
    ...
    "settings.ttsr.contextMode.description":
    ...
    "settings.display.shimmer.description":
    ...
    "settings.readLineNumbers.description":
    ...
    "settings.providers.antigravityEndpoint.option.production.description":
      "Force production endpoint only",
    "settings.providers.antigravityEndpoint.option.sandbox.label":
      "Sandbox Only",
    "settings.providers.antigravityEndpoint.option.sandbox.description":
      "Force sandbox endpoint only",
    ...
    "settings.providers.fireworksTier.option.standard.description":
      "Default serving path (no service_tier)",
    ...
    "settings.providers.kimiApiFormat.option.auto.description":
      "Use the model's server-declared protocol",
    ...
    "settings.providers.streamFirstEventTimeoutSeconds.option.-1.description":
      "Use provider defaults and PI_* timeout env vars",
    ...
    "settings.providers.streamIdleTimeoutSeconds.option.600.label":
      "10 minutes",
    "settings.providers.streamIdleTimeoutSeconds.option.1800.label":
      "30 minutes",
    ...
    "settings.providers.openrouterVariant.option.default.description":
      "No suffix; use OpenRouter's default routing",
    ...
    "settings.providers.openrouterVariant.option.nitro.description":
      "Prioritize throughput / lowest latency",
    ...
    "settings.providers.openrouterVariant.option.floor.description":
      "Prioritize cheapest available provider",
    ...
    "settings.providers.fetch.option.jina.description":
      "Uses r.jina.ai reader (JINA_API_KEY optional)",
    ...
    "settings.task.isolation.mode.option.auto.description":
      "Let the PAL pick the best available backend",
    ...
    "settings.task.maxConcurrency.description":
    ...
    "settings.task.maxEffort.option.low.description":
      "Light reasoning (~2k tokens)",
    ...
    "settings.task.maxEffort.option.max.description":
      "Maximum reasoning the model supports",
    ...
    "settings.commands.enableOpencodeUser.description":
      "Load commands from ~/.config/opencode/commands/",
    "settings.commands.enableOpencodeProject.label":
      "OpenCode Project Commands",
    "settings.commands.enableOpencodeProject.description":
      "Load commands from .opencode/commands/",
    "settings.bash.enabled.label": "Bash",
    "settings.bash.enabled.description":
    ...
    "settings.shellMinimizer.sourceOutlineLevel.label":
      "Shell Minimizer Source Outline",
    ...
    "settings.shellMinimizer.sourceOutlineLevel.option.default.label":
      "default",
    ...
    "settings.tools.artifactSpillThreshold.label":
    ...
    "settings.todo.eager.option.default.description":
      "Model decides; no automatic todo list",
    ...
    "settings.todo.eager.option.always.description":
      "Forces a comprehensive todo list on the first message",
    ...
    "settings.debug.enabled.description":
    ...
    "settings.inspect_image.mode.option.auto.label":
      "Auto (only for models without vision)",
    ...
    "settings.fetch.enabled.description":
    ...
    "settings.ask.enabled.description":
    ...
    "settings.tools.abortOnFabricatedResult.label":
    ...
    "settings.async.enabled.description":
    ...
    "settings.async.pollWaitDuration.option.smart.description":
      "Default — adaptive 5s→5m, resets when you stop polling",
    ...
    "settings.tools.xdevDocs.option.inline.description":
      "Inline docs and schemas for every mounted device.",
    ...
    "settings.tools.xdevDocs.option.catalog.description":
      "List every device; fetch all docs on demand.",
    ...
    "settings.mcp.notifications.description":
