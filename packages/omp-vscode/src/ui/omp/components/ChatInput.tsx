    ...
    <div className="sf-chat-input-wrap shrink-0 bg-transparent px-4 pb-2">
      ...
      <div className="mx-auto max-w-[820px]">
        ...
        <div className="relative min-w-0">
          ...
          <div
            className="sf-chat-input-box flex min-w-0 flex-col rounded-[14px] bg-[var(--tool-bg)] px-3 pb-2 pt-3 shadow-[0_8px_24px_-12px_var(--vscode-widget-shadow,rgba(15,23,42,0.10))] transition-[border-color,background,box-shadow] duration-150"
            style={{
