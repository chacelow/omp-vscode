...
function ModelNoticeBanner({ tone, title, body }: { tone: "error" | "warning"; title: string; body: string }) {
  ...
  return (
    <div
      role="alert"
      className="mb-2 flex max-h-[120px] items-start gap-2 overflow-y-auto rounded-md px-2.5 py-[7px] text-[11px] leading-[1.45]"
      style={{
...
export const ChatInput = forwardRef<ChatInputHandle, Props>(function ChatInput({
  ...
  return (
    <div className="sf-chat-input-wrap shrink-0 bg-transparent px-4">
      {/* Hidden file input */}
      <input
        ref={fileInputRef}
        type="file"
      ...
      <div className="mx-auto max-w-[820px]">
        ...
        <div className="relative min-w-0">
          ...
          <div
            className="sf-chat-input-box flex min-w-0 flex-col rounded-[14px] bg-[var(--input-bg)] px-3 pb-2 pt-3 transition-[border-color,background] duration-150"
            style={{
          ...
          <textarea
            ...
            style={{ fontSize: 12, WebkitTextSizeAdjust: "none" }}
          />
