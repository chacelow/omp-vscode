...
export const styles = {
  ...
  userText: "cm-user-text line-clamp-4 overflow-hidden [overflow-wrap:anywhere] whitespace-pre-wrap",
  assistant: "cm-assistant relative block border-t border-[color-mix(in_srgb,var(--border)_52%,transparent)]",
  assistantJump: cn(
