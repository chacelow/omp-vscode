      ...
      >
        <DropdownMenuTrigger asChild>
          <Button
            ...
            className="h-6 max-w-[180px] gap-1.5 overflow-hidden rounded-[9px] px-2 text-xs bg-[var(--bg-hover)] text-[var(--text)] hover:bg-[var(--bg-selected)] data-[state=open]:bg-[var(--bg-selected)]"
          >
