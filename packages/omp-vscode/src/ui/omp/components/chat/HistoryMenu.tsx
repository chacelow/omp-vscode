...
export const HistoryMenu = memo(function HistoryMenu({
  ...
  return (
    <div className="absolute inset-x-0 bottom-[calc(100%+8px)] z-[120] max-h-[min(44vh,360px)] overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--bg)] shadow-[0_-6px_20px_var(--vscode-widget-shadow, rgba(0,0,0,0.12))]">
